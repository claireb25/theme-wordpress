...
<div class="content_home">
    <div id="author-info">
        ...
        <div id="author-description">
            ...
            <h4 class="subpart-author">Tous ses articles</h4>
            <div class="all-their-articles">
            ...
            if ( $query->have_posts()) : while ( $query->have_posts() ) : $query->the_post(); ?> 
                ...
                <div class="one-article">
                    ...
                    <div class="content-article">
                        <div class="thumbnail-perso" style="background-image : url('<?php  echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); ?>');"></div>
