...
<div class="single-article-content">
    <div class="single-article">
        ...
        <div class="single-article-border">        
            <div class="thumbnail-perso-single-article" style="background-image : url('<?php  echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); ?>');"></div>
    ...
    <div class="author-meta">
        ...
        <div class="author-other-articles">
            <h4 class="subpart-author">ses autres articles</h4>
